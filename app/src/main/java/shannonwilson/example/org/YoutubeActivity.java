package shannonwilson.example.org;
...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyDd_7g7P6X2yRZza9AIq8W4mwkiMOdnBA0";
...
//        layout.addView(button1);
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onVideoEnded() {
            Toast.makeText(YoutubeActivity.this, "Congratulions, you've completed another video", Toast.LENGTH_LONG).show();
        }
